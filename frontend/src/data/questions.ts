...
const ALL_QUESTIONS: Question[] = [
  ...
  },
  {
    question_id: 17,
    question:
      'What was the name of the famous Roman emperor who issued the Edict of Milan, which granted religious tolerance to Christians in the Roman Empire?',
    answer_index: 3,
  ...
  },
  {
    question_id: 20,
    question:
      'What was the name of the famous Roman general who defeated the Egyptian forces of Cleopatra and Mark Antony in the Battle of Actium in 31 BC?',
    answer_index: 0,
...
export const getRandomQuestions = (count = 5): Question[] => {
